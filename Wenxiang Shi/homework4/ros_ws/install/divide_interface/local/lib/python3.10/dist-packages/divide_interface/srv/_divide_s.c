...
bool divide_interface__srv__divide__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("divide_interface.srv._divide.Divide_Request", full_classname_dest, 43) == 0);
  }
  divide_interface__srv__Divide_Request * ros_message = _ros_message;
  {  // dividend
...
{
  /* NOTE(esteve): Call constructor of Divide_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("divide_interface.srv._divide");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Divide_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool divide_interface__srv__divide__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("divide_interface.srv._divide.Divide_Response", full_classname_dest, 44) == 0);
  }
  divide_interface__srv__Divide_Response * ros_message = _ros_message;
  {  // quotient
...
{
  /* NOTE(esteve): Call constructor of Divide_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("divide_interface.srv._divide");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Divide_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
