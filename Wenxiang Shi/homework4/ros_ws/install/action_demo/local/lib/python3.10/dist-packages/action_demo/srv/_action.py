...
class Metaclass_Action_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('action_demo')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Action(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from action_demo.srv import _action
...
class Action(metaclass=Metaclass_Action):
    from action_demo.srv._action import Action_Request as Request
    from action_demo.srv._action import Action_Response as Response
