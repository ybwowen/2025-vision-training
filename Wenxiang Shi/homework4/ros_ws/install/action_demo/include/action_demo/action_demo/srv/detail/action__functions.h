...
#ifndef ACTION_DEMO__SRV__DETAIL__ACTION__FUNCTIONS_H_
#define ACTION_DEMO__SRV__DETAIL__ACTION__FUNCTIONS_H_
...
#include "action_demo/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_action_demo
bool
 ...
 * calls
 * action_demo__srv__Action_Request__init().
...
/**
 * It calls
 * action_demo__srv__Action_Request__fini()
 ...
 * action_demo__srv__Action_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * action_demo__srv__Action_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * action_demo__srv__Action_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_action_demo
...
/**
 * It calls
 * action_demo__srv__Action_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_action_demo
...
/**
 * It allocates the memory for the array and calls
 * action_demo__srv__Action_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_action_demo
...
/**
 * It calls
 * action_demo__srv__Action_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ACTION_DEMO__SRV__DETAIL__ACTION__FUNCTIONS_H_
