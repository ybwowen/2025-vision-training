    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_Goal')
            logger.debug(
...
class Metaclass_MoveRobot_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_Result(metaclass=Metaclass_MoveRobot_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.makeit = kwargs.get('makeit', bool())
    ...
    def makeit(self, value):
        if __debug__:
            assert \
                ...
                "The 'makeit' field must be of type 'bool'"
        self._makeit = value
...
class Metaclass_MoveRobot_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_Feedback(metaclass=Metaclass_MoveRobot_Feedback):
    ...
    def yet(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'yet' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'yet' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._yet = value
...
class Metaclass_MoveRobot_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from action_interfaces.action import MoveRobot
...
class MoveRobot_SendGoal_Request(metaclass=Metaclass_MoveRobot_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_interfaces/MoveRobot_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'MoveRobot_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._move_robot import MoveRobot_Goal
...
class Metaclass_MoveRobot_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_interfaces.action import _move_robot
...
class MoveRobot_SendGoal(metaclass=Metaclass_MoveRobot_SendGoal):
    from action_interfaces.action._move_robot import MoveRobot_SendGoal_Request as Request
    from action_interfaces.action._move_robot import MoveRobot_SendGoal_Response as Response
...
class MoveRobot_GetResult_Response(metaclass=Metaclass_MoveRobot_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_interfaces/MoveRobot_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'MoveRobot_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.status = kwargs.get('status', int())
        from action_interfaces.action._move_robot import MoveRobot_Result
...
class Metaclass_MoveRobot_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_GetResult(metaclass=Metaclass_MoveRobot_GetResult):
    from action_interfaces.action._move_robot import MoveRobot_GetResult_Request as Request
    from action_interfaces.action._move_robot import MoveRobot_GetResult_Response as Response
...
class Metaclass_MoveRobot_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_FeedbackMessage(metaclass=Metaclass_MoveRobot_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_interfaces/MoveRobot_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'MoveRobot_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_interfaces.action._move_robot import MoveRobot_Feedback
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    ...
    from action_interfaces.action._move_robot import MoveRobot_Goal as Goal
    # The result message defined in the action definition.
    from action_interfaces.action._move_robot import MoveRobot_Result as Result
    # The feedback message defined in the action definition.
    from action_interfaces.action._move_robot import MoveRobot_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_interfaces.action._move_robot import MoveRobot_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_interfaces.action._move_robot import MoveRobot_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_interfaces.action._move_robot import MoveRobot_FeedbackMessage as FeedbackMessage
