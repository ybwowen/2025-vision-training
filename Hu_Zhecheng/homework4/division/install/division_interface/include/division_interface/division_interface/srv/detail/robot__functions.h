...
#ifndef DIVISION_INTERFACE__SRV__DETAIL__ROBOT__FUNCTIONS_H_
#define DIVISION_INTERFACE__SRV__DETAIL__ROBOT__FUNCTIONS_H_
...
#include "division_interface/msg/rosidl_generator_c__visibility_control.h"

#include "division_interface/srv/detail/robot__struct.h"

/// Initialize srv/Robot message.
/**
...
/// Create srv/Robot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * division_interface__srv__Robot_Request__init().
...
/// Destroy srv/Robot message.
/**
 * It calls
 * division_interface__srv__Robot_Request__fini()
...
/// Check for srv/Robot message equality.
/**
...
/// Initialize array of srv/Robot messages.
/**
...
/// Finalize array of srv/Robot messages.
/**
 * It calls
 * division_interface__srv__Robot_Request__fini()
...
/// Create array of srv/Robot messages.
/**
 * It allocates the memory for the array and calls
 * division_interface__srv__Robot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Robot messages.
/**
 * It calls
 * division_interface__srv__Robot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Robot message array equality.
/**
...
/// Copy an array of srv/Robot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * division_interface__srv__Robot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_division_interface
...
/**
 * It calls
 * division_interface__srv__Robot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_division_interface
...
/**
 * It allocates the memory for the array and calls
 * division_interface__srv__Robot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_division_interface
...
/**
 * It calls
 * division_interface__srv__Robot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DIVISION_INTERFACE__SRV__DETAIL__ROBOT__FUNCTIONS_H_
